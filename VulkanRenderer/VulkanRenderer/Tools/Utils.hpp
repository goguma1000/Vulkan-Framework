...
namespace Utils {
	...
	void CreateFrameBuffer(VkFramebuffer& out, const VkDevice device, const std::vector<VkImageView>& attachments, const VkRenderPass renderpass, const VkExtent2D& swapChainExtent);
